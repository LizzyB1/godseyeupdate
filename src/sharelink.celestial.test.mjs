...
test('allocation strategy defaults to Elastic and round-trips Weighted', () => {
  ...
  const manager = makeManager();
  manager.onToggleChange({ detectionAllocation: 'WEIGHTED' });
  clearTimeout(manager._debounceTimer);
  manager._updateHash();
